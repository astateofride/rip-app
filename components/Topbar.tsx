  ...
  return (
    <>
      <div
        ...
        style={{ background: '#080810', borderBottom: '1px solid rgba(255,255,255,0.07)' }}
      >
        {/* Main row */}
          ...
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="flex items-center gap-2 min-w-0">
              ...
              <div className="leading-none min-w-0">
                <div className="font-display" style={{ fontSize: 10, color: '#e8c547', letterSpacing: '0.18em', marginBottom: 2 }}>
                  {mode === 'coach' ? 'COACH PORTAL' : 'STUDENT PORTAL'}
                </div>
                <div className="font-display" style={{ fontSize: 16, color: '#f0f0eb', letterSpacing: '0.05em', lineHeight: 1.1 }}>
          ...
          <div className="w-full rounded-t-3xl pb-8" style={{ background: '#111120', border: '1px solid rgba(255,255,255,0.08)' }} onClick={e => e.stopPropagation()}>
            ...
            <div className="px-5">
              <div className="flex items-center gap-3 mb-5 px-1">
                <div className="w-10 h-10 rounded-full flex items-center justify-center font-display flex-shrink-0" style={{ background: 'rgba(232,197,71,0.12)', border: '1px solid rgba(232,197,71,0.45)', color: '#e8c547', fontSize: 17 }}>{initials ?? '?'}</div>
                <div>
                  <div className="font-bold text-sm" style={{ color: '#f0f0eb' }}>{name ?? ''}</div>
          ...
          >
            ...
            <div className="px-6">
              <div className="flex items-center justify-between mb-5">
                <div>
                  <div className="text-[10px] font-bold uppercase tracking-widest mb-1" style={{ color: '#9898c0' }}>How this works</div>
              ...
              <div className="flex flex-col gap-4">
                {[
                  { num: '01', text: 'Work through each stage in order. Read the manual reference for each day before attempting the tasks.' },
                  { num: '02', text: 'Some tasks require a written answer. Tap the manual reference button (📖) to expand the section notes before writing. Your answer is self-assessed against key concepts on submission.' },
                  { num: '03', text: 'Written answers need to score 60% or above to count as passed. If you score below 60%, review the manual reference and resubmit.' },
                  { num: '04', text: 'Video tasks: record yourself on the bike and submit a link. Use Google Drive (share → "Anyone with the link") or YouTube (set to "Unlisted" — not Private).' },
                  { num: '05', text: 'Your coach reviews your progress, leaves notes, and signs off each stage. You cannot advance until your coach signs off.' },
                  { num: '06', text: 'Once all 3 stages are complete and signed off, RIDE Academy unlocks — your gateway to the full A State of Ride instructor network.' },
                ].map(step => (
                ...
                <div className="flex flex-col gap-2 mt-1">
                  <div className="flex items-start gap-3 px-4 py-3 rounded-xl" style={{ background: 'rgba(78,205,196,0.07)', border: '1px solid rgba(78,205,196,0.18)' }}>
                    ...
                    <div>
                      ...
                      <div className="text-xs leading-relaxed" style={{ color: '#9898c0' }}>Record → upload → right-click → Share → "Anyone with the link" → paste link</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 px-4 py-3 rounded-xl" style={{ background: 'rgba(255,107,157,0.07)', border: '1px solid rgba(255,107,157,0.18)' }}>
                    ...
                    <div>
                      ...
                      <div className="text-xs leading-relaxed" style={{ color: '#9898c0' }}>Upload → set to <strong style={{ color: '#f0f0eb' }}>"Unlisted"</strong> (not Private) → paste link</div>
                    </div>
                  </div>
                </div>
              </div>
