...
export default function StageView({ stageIdx, userId, tasks, dayData, remarks, signoffs, unreadCount, previewMode, onBack }: Props) {
  ...
  return (
    <div style={{ background: '#080810', minHeight: '100dvh', paddingBottom: 100 }}>
      ...
      {/* Manual popup */}
      {manualPopup && (
        <div className="fixed inset-0 z-[300] flex items-end justify-center" style={{ background: 'rgba(0,0,0,0.7)', padding: '0 12px 12px' }} onClick={() => setManualPopup(null)}>
          <div className="w-full rounded-3xl p-6 pb-10" style={{ background: '#111120', border: '1px solid rgba(255,255,255,0.07)', maxHeight: '70vh', overflowY: 'auto', maxWidth: 480 }}
      ...
      {/* Self-assess modal */}
      {selfAssessModal && (
        <div className="fixed inset-0 z-[360] flex items-end justify-center" style={{ background: 'rgba(0,0,0,0.75)', padding: '0 12px 12px' }}>
          <div className="w-full rounded-3xl pb-10" style={{ background: '#111120', border: '1px solid rgba(255,255,255,0.08)', maxWidth: 480 }}>
      ...
      {/* Coach ping prompt */}
      {coachPrompt && (
        <div className="fixed inset-0 z-[350] flex items-end justify-center" style={{ background: 'rgba(0,0,0,0.65)', padding: '0 12px 12px' }}
